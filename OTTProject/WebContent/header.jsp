								...
								<div class="accordion-box">
									<ul class="list">
										...
										<li>
											...
											<div class="con">
											<a href="view/main/genre.jsp" style="text-decoration:none">로맨스</a><br>
											<a href="view/main/genre.jsp">코미디</a><br>
											<a href="view/main/genre.jsp">스릴러</a><br>
											<a href="view/main/genre.jsp">미스터리</a><br>
											<a href="view/main/genre.jsp">액션</a><br>
											<a href="view/main/genre.jsp">판타지</a><br>
											<a href="view/main/genre.jsp">공포</a><br>
											<a href="view/main/genre.jsp">키즈</a><br>
											<a href="view/main/genre.jsp">애니메이션</a><br>
										</div>
										</li>
										<li>
											<p class="title"><a href="#">마이페이지</a></p>
											<div class="con"><a href="elements.html" style="text-decoration:none">본인정보</a><br>
											<a href="subpay.html">결제내역</a><br>
